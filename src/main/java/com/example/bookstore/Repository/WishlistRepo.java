...
public interface WishlistRepo extends JpaRepository<Wishlist, Long> {
    ...
    @Query(value = "SELECT * FROM wishlist WHERE userid = :userid AND bookid = :bookid", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "DELETE FROM wishlist WHERE userid = :userid AND bookid = :bookid", nativeQuery = true)
